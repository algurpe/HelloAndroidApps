...
public class MainActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!isInTwoPaneMode()) {
			...
			// STEP 1: Get reference to FragmentManager
			FragmentManager fm = getFragmentManager();
			
			// STEP 2: Call beginTransaction() method on FragmentManager
			FragmentTransaction ft = fm.beginTransaction();
			
			// STEP 3: Call add() method, pass in id and fragment.
			ft.add(R.id.friends_frag, mFriendsFragment);
			
			// STEP 4: Call commit() method
			ft.commit();
