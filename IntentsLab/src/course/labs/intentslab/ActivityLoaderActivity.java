...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Toast toast = Toast.makeText(getApplicationContext(), "Entered startExplicitActivation()", Toast.LENGTH_SHORT);
		toast.show();
	...
	private void startImplicitActivation() {
		...
		Toast toast1 = Toast.makeText(getApplicationContext(), "Entered startImplicitActivation()", Toast.LENGTH_SHORT);
		toast1.show();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		Toast toast2 = Toast.makeText(getApplicationContext(), "Entered onActivityResult()", Toast.LENGTH_SHORT);
		toast2.show();
